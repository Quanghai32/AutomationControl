...
namespace KeyenceHostLinkLib
{
    ...
    public class PLCEditBox_ActionLists : DesignerActionList
    {
        private PLCEditBox dtc;
        private DesignerActionUIService designerActionUISvc;
        public PLCEditBox_ActionLists(IComponent component) : base(component)
        {
            this.dtc = component as PLCEditBox;
